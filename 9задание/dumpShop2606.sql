...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cities` (
  `label` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'en',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ru',
  PRIMARY KEY (`label`)
...
CREATE TABLE `flights` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `from` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'en',
  `to` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'en',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Заказы';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,'2017-01-25 00:00:00','2020-06-26 02:18:42'),(2,3,'2015-01-15 00:00:00','2020-06-26 02:18:42'),(3,2,'2019-05-25 00:00:00','2020-06-26 02:18:42');
...
INSERT INTO `products` VALUES (1,'Intel Core i3-8100','Процессор для настольных персональных компьютеров, основанных на платформе Intel.',7890.00,1,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(2,'Intel Core i5-7400','Процессор для настольных персональных компьютеров, основанных на платформе Intel.',12700.00,1,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(3,'AMD FX-8320E','Процессор для настольных персональных компьютеров, основанных на платформе AMD.',4780.00,1,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(4,'AMD FX-8320','Процессор для настольных персональных компьютеров, основанных на платформе AMD.',7120.00,1,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(5,'ASUS ROG MAXIMUS X HERO','Материнская плата ASUS ROG MAXIMUS X HERO, Z370, Socket 1151-V2, DDR4, ATX',19310.00,2,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(6,'Gigabyte H310M S2H','Материнская плата Gigabyte H310M S2H, H310, Socket 1151-V2, DDR4, mATX',4790.00,2,'2020-06-26 01:44:39','2020-06-26 01:44:39'),(7,'MSI B250M GAMING PRO','Материнская плата MSI B250M GAMING PRO, B250, Socket 1151, DDR4, mATX',5060.00,2,'2020-06-26 01:44:39','2020-06-26 01:44:39');
...
INSERT INTO `users` VALUES (1,'Геннадий','1990-10-05','2020-06-26 01:43:30','2020-06-26 01:43:30'),(2,'Наталья','1984-11-12','2020-06-26 01:43:30','2020-06-26 01:43:30'),(3,'Александр','1985-05-20','2020-06-26 01:43:30','2020-06-26 01:43:30'),(4,'Сергей','1988-02-14','2020-06-26 01:43:30','2020-06-26 01:43:30'),(5,'Иван','1998-01-12','2020-06-26 01:43:30','2020-06-26 01:43:30'),(6,'Мария','1992-08-29','2020-06-26 01:43:30','2020-06-26 01:43:30');
...
-- Dump completed on 2020-06-26  2:34:18
